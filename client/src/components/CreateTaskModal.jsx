...
import { CreateProject, GmailSendCreaet } from '../feature/project/projectslice';
import { CreateProjects } from '../feature/task/taskslice';

const CreateTaskModal = ({ memberid, onClose ,projectid,user}) => {
...
dispatch(CreateProjects({formData,assignedTo:memberid,projectId:projectid}))
dispatch(GmailSendCreaet(user.email))
